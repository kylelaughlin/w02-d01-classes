...
class GuitarTest < Minitest::Test
  ...
  def test_pickup_type_getter
    guitar = Guitar.new(model: "Les Paul", brand: "Gibson", pickup_type: "Humbuckers", color: "Red")
    assert_equal("Humbuckers", guitar.pickup_type)
  end

  def test_pickup_type_setter
    guitar = Guitar.new(model: "Les Paul", brand: "Gibson", pickup_type: "Humbuckers", color: "Red")
    guitar.pickup_type = "Single Coil"
    assert_equal("Single Coil", guitar.pickup_type)
  end
